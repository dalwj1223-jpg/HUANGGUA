    ...
    <div className="relative flex flex-col items-center select-none w-full max-w-[375px]">
      ...
      >
        ...
        <div className="absolute top-14 left-4 z-20 pointer-events-none flex flex-col gap-1.5 items-start">
          ...
          {/* Consecutive Monster Defeat Combo Streak Indicator */}
          {comboCount >= 2 && (
            <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-linear-to-r from-amber-500 via-orange-500 to-rose-500 border border-amber-200/90 text-white font-black text-xs shadow-md animate-bounce">
              <span>🔔</span>
              <span>{comboCount} 连击 叮!</span>
            </div>
          )}
        </div>
